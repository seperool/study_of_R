...
- Correlação linear:\
  ...
  $$cor_{x,y} = \frac{n \sum x_i y_i \, \cdot \, \sum x_i \sum y_i}{ \sqrt{ n \sum x_i^2  - ( \sum x_i)^2} \, \cdot \, \sqrt{ n \sum y_i^2  - ( \sum y_i)^2}}$$
  ...
  - `cor(x,y)`\
  Função no **R** que cálcula a correlação linear das variáveis vetor x e y.\ 
