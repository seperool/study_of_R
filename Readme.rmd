...
1. identificando/mudando tipos de variáveis\
    i. Identificando o tipo de variável:\
    Uso do **is**.\
    ii. Mudando o tipo de variável:\
    Uso do **as**.\
...
- Principais parâmetros, das funções de importação, do pacote `readr`:\
  - `file = `\
  Define o caminho, que deve ser pecorrido, e o arquivo, no formato .csv, a ser importado. Deve estar entre aspas.\
...
- Observações:\
  - O separador, assim como outros parâmetros, podem ser modificados na função.\
