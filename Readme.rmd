...
### Substitua valores perdidos - `mice()`

- Apesar do `janitor` auxilia a eliminar linhas e colunas com valores perdidas, caso necessite substituir tais valores, o pacote `mice` ajuda nessa tarefas, usando técnica de imputação de valores (*Multivariate Imputation by Chained Equations*), que levam em conta o tipo de variável, produzindo a substituição dos valores pedidos.\
