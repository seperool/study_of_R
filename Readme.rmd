...
#### Gráfico de dispersão com linha de tendência usando ggplot2
...
- A suavização de smooth descreve uma tendência (uma variabilidade), apresentando maior ou menor confiabilidade (área cinza do gráfico) da estimativa de tendência, dependendo da quantidade de pontos no local.\
...
![Gráfico de tendência com curva suavizada smooth, com `method = lm, se = FALSE` (**regressão linear**).](./Cap7-graficos_basicos_e_ggplot2/Imagens/geom_smooth-regressao_linear.png){ width=50% }
