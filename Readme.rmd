...
![Modelo 2 de visualização de escala *Likert*.](./Cap8-Limpeza_dados/Imagens/plot_likert_ex2.png){ width=50% }


\newpage

![Modelo 3 de visualização de escala *Likert*.](./Cap8-Limpeza_dados/Imagens/plot_likert_ex3.png){ width=50% }
