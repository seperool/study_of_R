...
|                                                                                     power.prop.test()                                                                                     |                                                Calcula o poder do teste de proporção.                                                |
|                                                                                      power.t.test()                                                                                       |                                                     Calcula o poder do teste t.                                                      |
|                                                                                         PP.test()                                                                                         |                                             Teste Phillips-Perron para raízes unitárias.                                             |
|                                                                                        prop.test()                                                                                        |                                         Teste para a proporção de sucessos em vários grupos.                                         |
|                                                                                     prop.trend.test()                                                                                     |                                          Teste Qui-quadrado para a tendência da proporção.                                           |
|                                                                                       quade.test()                                                                                        |                                           Teste Quade para dados em blocos não duplicados.                                           |
|                                                                                      shapiro.test()                                                                                       |                                   Teste de Shapiro-Wilk para verificar a normalidade da variável.                                    |
|                                                                                         t.test()                                                                                          |                    Teste t para comparação da média de uma amostra ou duas amostras (pareadas ou independentes).                     |
|                                                                                        TukeyHSD()                                                                                         |                                   Teste de Tukey para comparar par a par a diferença entre médias.                                   |
|                                                                                        var.test()                                                                                         |                                         Teste F para comparação de igualdade de variâncias.                                          |
|                                                                                       wilcox.test()                                                                                       |                        Teste de Wilcoxon para o posto de sinais. Também conhecido como Teste de Mann-Whitney.                        |
