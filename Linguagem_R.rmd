...
### Categórica $\sim$ numérica
#### Passos da criação do modelo categórica $\sim$ numérica 
- Pacote `nnet` fornece modelo de regressão logística.\
- No Pacote `nnet`, a função `multinom()` é usada para obtenção dos coeficientes do modelo.\
- Modelos de regressão logística:\
  - Para duas categóricas:\
    - Binária ou Binomial\
...
- Definir o tipo de regressão logística aplicada:\
Com base na caracteristica da variável categórica (resposta), fica claro qual o tipo de regressão logística devemos trabalhar.\
