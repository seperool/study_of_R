...
- Passos (resumo):\
  ...
  - Modelo\
    - Checagem de pressupostos:\
      1. Variável dependente **Dicotômica** (pelo menos).\
      2. Independencia das observações (sem medidas repetidas).\
      3. Ausência de outliers/pontos de alavancagem (Plotar gráfico).\
    - Modelagem:\
      - Gerar modelo.\
...
- Definir o tipo de **regressão logística** há aplicar:\
